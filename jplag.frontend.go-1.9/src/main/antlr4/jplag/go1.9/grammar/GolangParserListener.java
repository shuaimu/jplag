 ...
 * {@link GolangParser}.
 */
public interface GolangParserListener extends ParseTreeListener {
	/**
	...
	/**
	 * Enter a parse tree produced by {@link GolangParser#type_}.
	 * @param ctx the parse tree
	 */
	void enterType_(GolangParser.Type_Context ctx);
	/**
	 * Exit a parse tree produced by {@link GolangParser#type_}.
	 * @param ctx the parse tree
	 */
	void exitType_(GolangParser.Type_Context ctx);
	/**
